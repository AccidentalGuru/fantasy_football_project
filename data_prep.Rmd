...
ffw1 = setnames(ffw1, old = c("points", "pos_rank", "floor", "ceiling", 
                              "pos_ecr", "risk"), new = c("points_w1", 
                                                          "pos_rank_w1", 
                                                          "floor_w1", "ceiling_w1", 
                                                          "pos_ecr_w1", 
                                                          "risk_w1"))
...
ffw2 = setnames(ffw2, old = c("points", "pos_rank", "floor", "ceiling", 
                              "pos_ecr", "risk"), new = c("points_w2", 
                                                          "pos_rank_w2", 
                                                          "floor_w2", 
                                                          "ceiling_w2", 
                                                          "pos_ecr_w2", "risk_w2"))
...
robust_ff = subset(master_ff, avg_type == "robust" & pos %in% c("QB", 
                                                                "RB", 
                                                                "WR", 
                                                                "TE") & team != "FA", 
                   select = c(id, name, team, pos, exp, age, adp, pointspg_w0, 
                              pos_rank_w0, floorpg_w0, ceilingpg_w0, pos_ecr_w0, 
                              risk_w0, points_w1, pos_rank_w1, floor_w1, ceiling_w1, 
                              pos_ecr_w1, risk_w1, points_w2, pos_rank_w2, floor_w2, 
                              ceiling_w2, pos_ecr_w2, risk_w2))
